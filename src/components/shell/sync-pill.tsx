...
export function SyncPill() {
  ...
  const toneClass = `is-${variant.tone === "muted" ? "" : variant.tone}`.replace("is-", (m) => (variant.tone === "muted" ? "" : m))
  ...
  return (
    ...
    >
      <variant.Icon className={cn("h-3 w-3 -ms-1", variant.spin && "animate-spin")} strokeWidth={2} aria-hidden />
