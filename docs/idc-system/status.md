...
_Last updated: 2026-05-12 (Phase 06 complete). Source: [roadmap.md](./roadmap.md)._
...
| Tauri IPC commands | 0 | 91 (sync: 9, auth: 6, users: 7, settings: 3, catalog: 37, shifts: 8, patients: 4, visits: 11, receipts: 1, inventory ops: 5) | ~55-67 |
...
| Frontend pages | 2 (`/`, `*`) | 25 (Phase 1+2: 9 + Phase 3: 8 admin pages + Phase 4: 1 reception page (`/reception/shifts`) + Phase 5: 4 reception pages: `/reception` index, `/reception/checks/:slug`, `/reception/checks/:slug/new`, `/reception/visits/:id` + Phase 6: 3 inventory ops pages: `/inventory`, `/inventory/items/:id`, `/inventory/adjust`) | 31 |
...
| Locales | 2 (ar+en) | 2 (7 namespaces: `common`, `errors`, `receipts`, `auth`, `admin`, `reception`, `inventory`) | 2 |
