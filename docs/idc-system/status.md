...
| Tauri IPC commands | 0 | 86 (sync: 9, auth: 6, users: 7, settings: 3, catalog: 37, shifts: 8, patients: 4, visits: 11, receipts: 1) | ~55-67 |
...
| Frontend pages | 2 (`/`, `*`) | 22 (Phase 1+2: 9 + Phase 3: 8 admin pages + Phase 4: 1 reception page (`/reception/shifts`) + Phase 5: 4 reception pages: `/reception` index, `/reception/checks/:slug`, `/reception/checks/:slug/new`, `/reception/visits/:id`) | 31 |
